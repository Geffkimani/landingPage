        ...
        <section id='projects' className="py-16 md:py-32">
            <div className="mx-auto max-w-6xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-4xl font-medium lg:text-5xl">Built by Developers Who Understand Your Needs.</h2>
                    <p>At Kymcode, we build projects that empower developers and bring real value to businesses — from smart APIs to full-scale applications.</p>
                </div>
